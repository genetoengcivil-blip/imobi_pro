...
export default function DashboardPage() {
  ...
  // --- NOVA LÓGICA DE MÉTRICAS DE AUTOMAÇÃO ---
  const automationStats = useMemo(() => {
    ...
    return { totalAutomacoes, taxaEngajamento };
  }, [safeLeads]);
  ...
  return (
    <div className="space-y-8 animate-fade-in pb-20 font-sans p-6">
      ...
      {/* NOVO: INDICADORES DE IMPACTO DA AUTOMAÇÃO */}
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className={`${cardClass} flex items-center gap-6 border-l-4 border-l-[#0217ff]`}>
          ...
          <div>
            ...
            <div className="text-3xl font-black italic tracking-tighter">{automationStats.totalAutomacoes}</div>
            <p className="text-[10px] text-zinc-500 font-bold uppercase mt-1 italic tracking-tight">Leads atendidos automaticamente</p>
          </div>
        </div>
        <div className={`${cardClass} flex items-center gap-6 border-l-4 border-l-green-500`}>
          ...
          <div>
            ...
            <div className="text-3xl font-black italic tracking-tighter">{automationStats.taxaEngajamento}%</div>
            <p className="text-[10px] text-zinc-500 font-bold uppercase mt-1 italic tracking-tight">Taxa de resposta dos novos leads</p>
          </div>
        </div>
      </div>
