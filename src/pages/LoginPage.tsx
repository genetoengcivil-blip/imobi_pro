...
export default function LoginPage() {
  ...
  // Se já estiver logado e ativo, o sistema leva para o dashboard automaticamente
  useEffect(() => {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // O onAuthStateChange do GlobalContext cuidará de carregar o perfil.
      // Apenas aguardamos o redirecionamento do useEffect acima.
  ...
  return (
    <div className="min-h-screen bg-black text-white flex flex-col items-center justify-center p-6 font-sans">
      <div className="w-full max-w-[440px]">
        <div className="bg-zinc-950 border border-white/5 rounded-[48px] p-10 shadow-2xl relative">
