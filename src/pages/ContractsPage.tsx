    ...
    <div className="p-6 max-w-7xl mx-auto">
      ...
      <div className="flex justify-between items-center mb-6">
        <div>
          ...
          <p className="text-zinc-500 text-sm">{contracts.length} contratos</p>
        </div>
        <button
          onClick={() => openModal()}
      ...
      {loading ? (
        ...
        <div className={`${theme.card} border rounded-2xl p-12 text-center`}>
          ...
          <p className="text-zinc-500 text-sm mt-2">
            {searchTerm ? 'Tente outro termo de busca' : 'Clique em "Novo Contrato" para começar'}
          </p>
        </div>
      ) : (
              ...
              {viewMode === 'view' ? (
                ...
                <form onSubmit={(e) => { e.preventDefault(); handleSave(); }} className="space-y-4">
                  ...
                  <div>
                    ...
                    {properties.length === 0 && (
                      <p className="text-xs text-red-500 mt-1">Nenhum imóvel cadastrado</p>
                    )}
                  </div>
